...
### Доступ из хостовой к VM по ssh
...
### Доступ из хостовой к VM по http, https
* 2 способ
...
* 4 способ: "Виртуальный адаптер хоста"
  + если к виртуалке нужен доступ только с хоста
  + по умолчанию виртуалке присваивается адрес из сети 192.168.56.0/24, хосту 192.168.56.1

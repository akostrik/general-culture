...
* 2 способ
  ...
  + запустить сеть виртуальной машины в режиме "Сетевой мост", сетевой мост вместо NAT
  + виртаулку автоматически видно всем из сети
  + на виртуалке нет интернета
  + в Port Forwardign Rules айпи = 0.0.0.0
* 3 способ
  + произвести настройки на NAT
  + поставить мост
...
* 5 способ:  Виртуальный адаптер хоста VirtualBox

...
* Bind Mounts
  ...
  + поделиться существующими файлами или конфигурациями
  + работать с файлами локально и видеть изменения сразу в контейнере
  + доступ к исходным данным или кода на хосте, чтобы изменения сразу отражались в контейнере

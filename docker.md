...
* use cases:
  + Database storage – to the storage directories used by MySQL, Postgres,Mongo
  + Application data – to store data generated by your application (file uploads, profile photos, ...)
  + Essential caches – to persist the contents of any caches
  + Convenient data backups - to backup container data by mirroring /var/lib/docker/volumes to another location

...
* the deployment of stateful Docker containers
...
* use cases:
  + Database storage – You should mount a volume to the storage directories used by databases such as MySQL, Postgres, and Mongo
  + Application data – to store data generated by your application, such as file uploads, documents, and profile photos
  + Essential caches – to persist the contents of any caches
  ...
  + Write to remote filesystems – containers write to remote filesystems and network shares. 

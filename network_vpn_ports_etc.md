...
* иерархическая структура имён и зон
  + каждый сервер, отвечающий за имя, может передать ответственность за дальнейшую часть домена другому серверу => ответственность за информацию на серверах различных организаций, отвечающих только за «свою» часть доменного имени

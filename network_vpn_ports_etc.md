...
```
REST API. Сам по себе веб-API можно составить как угодно. Но для удобства разработчиков существует REST API — определённый набор стандартов по составлению API с помощью протокола HTTP. Этот набор правил позволяет унифицировать программные интерфейсы и сделать их понятными и читабельными.

...
* бывают
  + проводные
  + бепроводные
* исходя из поколения шины, бывают:
  + ISA, выпущенные в 1981 году. Такую шину отличает небольшая скорость передачи — до 9 Мбит/с;
  + PCI, созданные в 1990 году. Эти шины  устанавливались на серверах, а позже и в компьютерах. Этот вид устарел для современных ПК;
  + PCI-X, модернизированная вариация PCI, обычно используется для серверов;
  + PCIe, новейший стандарт. Применяется на ПК и серверах. Существуют пять версий, каждая из которых формирует пять видов линий связи с различной скоростью;
  + USB, стандарт внешней шины. Существуют три версии, которые поддерживают разную скорость и могут работать с различными устройствами. Подходит для подсоединения к Wi-Fi.
*  по типу портов, бывают:

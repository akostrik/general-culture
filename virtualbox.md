...
* 1 способ получить доступ к какому-либо сервису хостовой машины: через талицу таблица Port Forwardign Rules пробросить пробросить порт сервиса в хостовую систему
  + Имя
...
* 2 способ получить доступ к какому-либо сервису хостовой машины: выдать виртуальной машине отдельный IP адрес
  + это позволит обращаться к любым ее портам и использовать любые сетевые возможности = Виртуальный адаптер хоста VirtualBox
* 3 способ
  + В таблице Port Forwardign Rules айпи на 0.0.0.0
  + запустил сеть виртуальной машины в режиме "Сетевой мост"
* 4 способ: выставить тип подключения в настройках сетевого адаптера
